...
// filling histograms LV/HV //
for(int it = 0; it< IterationTest; it++){
  if(test_type == 0 || test_type == 2){
   h_passedHV_Cont[it] = TestContinuityPSPP1[it]->FillStatusHistogram(Form("h_passedHV_Continuity_all", it+1), "HV");
   h_passedLV_Cont[it] = TestContinuityPSPP1[it]->FillStatusHistogram(Form("h_passedLV_continuity_%i", it+1), "LV");
   hCont_ResChannel_HV[it] = TestContinuityPSPP1[it]->FillResistenceChannelHistogram(Form("h_resistenceLV_continuity_%i", it+1), "LV");
   ...
   h_passedIns_tot[it] = TestIsolationPSPP1[it]->FillStatusHistogram(Form("h_passed_Isolation_all"));
...
plotting<TH1I*>(h_passedIns_tot , "InsulationTest_All_Passed-Failed", 1);
plotting<TH1I*>(h_passedHV_Ins , "InsulationTest_HV_Passed-Failed", 2);
plotting<TH1I*>(h_passedLV_Ins , "InsulationTest_LV_Passed-Failed", 3);
plotting<TH1F*>(hIns_ResChannel_HV , "InsulationTest_HV_Resistence", 4);
plotting<TH1F*>(hIns_ResChannel_LV , "InsulationTest_LV_Resistence", 5);
}
if(test_type == 0 ){
...
plotting<TH1I*>(h_passedCont_tot ,"ContinuityTest_All_Passed-Failed", 3);
plotting<TH1F*>(hCont_ResChannel_HV,"ContinuityTest_ResistenceHV", 4);
plotting<TH1F*>(hCont_ResChannel_LV,"ContinuityTest_ResistenceLV", 5);
}
if(test_type == 2){
sPDFTitle = TestIsolationPSPP1[0]->GetName() + "___" + currentDate;
